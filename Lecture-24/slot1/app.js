...
let p=[
    ...
    {
        P_img:"https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZWFyYnVkc3xlbnwwfHwwfHx8MA%3D%3D",P_id:1111,P_name:"Earbuds" ,P_price:2000 ,P_qty:3
    },
    {
...
app.get('/product/:id/edit',(req,res)=>{
   ...
   let r= p.filter(data=>data.P_id==id);
...
app.put('/product/:id',(req,res)=>{
    let {E_name,E_price,E_id,E_qty,E_img}=req.body;
     let d=p.filter(data=>data.P_id!=req.params.id);
     p=d;
    p.push({
        P_name:E_name,
        P_price:E_price,
